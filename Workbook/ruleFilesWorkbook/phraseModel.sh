...
awk '{if ($1 ~ /\*-/) print $1"\011"$1"\011"$1; else print $0}' /tmp/$1.closing > /tmp/$1.closing1
cat /tmp/$1.comments /tmp/$1.metaData /tmp/$1.metre /tmp/$1.tpt3 /tmp/$1.closing1
